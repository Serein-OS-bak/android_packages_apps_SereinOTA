...
import com.Serein.ota.MainActivity;
import com.Serein.ota.R;
import com.Serein.ota.configs.AppConfig;
import com.Serein.ota.configs.LinkConfig;
import com.Serein.ota.configs.OTAConfig;
import com.Serein.ota.configs.OTAVersion;
import com.Serein.ota.dialogs.WaitDialogHandler;
import com.Serein.ota.utils.OTAUtils;
import com.Serein.ota.xml.OTADevice;
import com.Serein.ota.xml.OTAParser;
...
public class CheckUpdateTask extends AsyncTask<Context, Void, OTADevice> {
    ...
    private void showNotification(Context context) {
        if (mIsBackgroundThread) {
            ...
            int notifyID = 1;
            String id = "Sereinota_channel";
            CharSequence name = context.getString(R.string.Serein_channel);
            String description = context.getString(R.string.Serein_channel_description);
            ...
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context.getApplicationContext())
                    .setSmallIcon(R.drawable.ic_notification_serein)
